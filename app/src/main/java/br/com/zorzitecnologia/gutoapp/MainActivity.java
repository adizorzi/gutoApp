...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagemAdapter = new ImagemAdapter(dados, getApplicationContext());
    ...
    public void getListImg (List<Imagens> listaSelecionados) {
        ImagemAdapter adapter;
        adapter = new ImagemAdapter(listaSelecionados,getApplicationContext());
        lstDados.setLayoutManager(new LinearLayoutManager(this));
